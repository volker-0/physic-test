...
const runWinDeployQt = (appName, buildDir) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const winDeployQt = child_process_1.spawn(winDeployQtBin, [
        ...allAddons,
        "--verbose=2",
        "--release",
        "--no-translations",
...
exports.init = (appName) => __awaiter(void 0, void 0, void 0, function* () {
    const config = {
        appName: null
    };
...
exports.pack = (distPath) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield patchQode_1.switchToGuiSubsystem(path_1.default.resolve(buildAppPackage, "qode.exe"));
