    ...
    constructor(parent, strings) {
        ...
        if (helpers_1.checkIfNativeElement(parent)) {
            ...
            if (parent instanceof QTreeWidgetItem || parent instanceof QTreeWidget_1.QTreeWidget) {
                ...
                if (strings) {
                    this.native = new addon_1.default.QTreeWidgetItem(parent.native, strings, type);
                }
                else {
                    this.native = new addon_1.default.QTreeWidgetItem(parent.native, type);
                }
            }
            else if (Array.isArray(parent)) {
                const strings = parent;
                this.native = new addon_1.default.QTreeWidgetItem(strings);
            }
            else {
                this.native = new addon_1.default.QTreeWidgetItem();
            }
        }
    }
    setText(column, text) {
