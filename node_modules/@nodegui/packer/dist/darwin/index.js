...
function init(appName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield helpers_1.fixupTemplateApp(config, templateApp);
    });
}
exports.init = init;
function pack(distPath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield helpers_1.copyQode(MacOs);
        console.log(`copying dist`);
        yield helpers_1.copyAppDist(distPath, resourceDir);
        console.log(`running macdeployqt`);
        yield helpers_1.runMacDeployQt({ appName, buildDir: helpers_1.buildDir, resourceDir });
