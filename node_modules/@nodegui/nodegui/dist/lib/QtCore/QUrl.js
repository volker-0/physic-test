...
exports.QUrl = exports.ParsingMode = void 0;
...
class QUrl extends Component_1.Component {
    constructor(arg, parsingMode = ParsingMode.TolerantMode) {
        super();
        this.ComponentFormattingOption = ComponentFormattingOption;
        this.ParsingMode = ParsingMode;
        this.UrlFormattingOption = UrlFormattingOption;
        this.UserInputResolutionOption = UserInputResolutionOption;
        if (!arg) {
            this.native = new addon_1.default.QUrl();
        }
        else if (helpers_1.checkIfNativeElement(arg)) {
            this.native = arg;
        }
        else {
            this.native = new addon_1.default.QUrl(arg, parsingMode);
        }
    }
...
exports.QUrl = QUrl;
QUrl.ComponentFormattingOption = ComponentFormattingOption;
QUrl.ParsingMode = ParsingMode;
QUrl.UrlFormattingOption = UrlFormattingOption;
QUrl.UserInputResolutionOption = UserInputResolutionOption;
