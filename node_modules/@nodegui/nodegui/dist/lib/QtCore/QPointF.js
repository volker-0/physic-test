...
class QPointF extends Component_1.Component {
    constructor(arg, y = 0) {
        ...
        if (helpers_1.checkIfNativeElement(arg)) {
            ...
            this.native = new addon_1.default.QPointF(arg, y);
        }
        else if (arg instanceof QPoint_1.QPoint) {
            this.native = new addon_1.default.QPointF(arg.x(), arg.y());
        }
        else {
            this.native = new addon_1.default.QPointF();
        }
    }
    /**
