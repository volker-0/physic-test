 ...
 */
export declare abstract class NodeTextEdit<Signals extends QTextEditSignals> extends QAbstractScrollArea<Signals> {
...
export declare class QTextEdit extends NodeTextEdit<QTextEditSignals> {
