...
```
 */
export declare abstract class NodeListView<Signals extends QListViewSignals> extends QAbstractItemView<Signals> {
...
export declare class QListView extends NodeListView<QListViewSignals> {
