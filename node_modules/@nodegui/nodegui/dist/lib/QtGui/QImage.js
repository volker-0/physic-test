...
class QImage extends Component_1.Component {
    constructor(arg, formatOrHeight, format) {
        ...
        if (helpers_1.checkIfNativeElement(arg)) {
            ...
            this.native = new addon_1.default.QImage(arg);
        }
        else if (typeof arg === 'number') {
            this.native = new addon_1.default.QImage(arg, formatOrHeight, format);
        }
        else if (arg instanceof QSize_1.QSize) {
            this.native = new addon_1.default.QImage(arg.native, formatOrHeight);
        }
        else {
            this.native = new addon_1.default.QImage();
        }
    }
    /**
    ...
    setPixelColor(positionOrX, colorOrY, color) {
        ...
        this.native.setPixelColor(positionOrX, colorOrY, color === null || color === void 0 ? void 0 : color.native);
    }
