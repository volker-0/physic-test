/****************************************************************************
** Meta object code from reading C++ file 'ntableview.hpp'
**
...
#include <memory>
#include "../../../../src/cpp/include/nodegui/QtWidgets/QTableView/ntableview.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'ntableview.hpp' doesn't include <QObject>."
...
struct qt_meta_stringdata_NTableView_t {
    QByteArrayData data[47];
    char stringdata0[547];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_NTableView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NTableView_t qt_meta_stringdata_NTableView = {
    {
QT_MOC_LITERAL(0, 0, 10), // "NTableView"
...
QT_MOC_LITERAL(46, 539, 7) // "yBorder"
    ...
    "NTableView\0yDisplay\0yAlignItems\0"
...
void NTableView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{

#ifndef QT_NO_PROPERTIES
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<NTableView *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject NTableView::staticMetaObject = { {
    QMetaObject::SuperData::link<QTableView::staticMetaObject>(),
    qt_meta_stringdata_NTableView.data,
    qt_meta_data_NTableView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *NTableView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NTableView.stringdata0))
